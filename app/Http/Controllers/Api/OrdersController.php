...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($data['user'])) {
            $user = $data['user'];
            $orders = DB::table($this->_PRFIX_TABLE . '_wc_orders')->join($this->_PRFIX_TABLE . '_posts', $this->_PRFIX_TABLE . '_posts.ID', $this->_PRFIX_TABLE . '_wc_orders.id')->where($this->_PRFIX_TABLE . '_wc_orders.customer_id', $user->ID)->where($this->_PRFIX_TABLE . '_posts.post_status', '!=', 'trash')->orderBy($this->_PRFIX_TABLE . '_wc_orders.date_created', 'DESC')->get();
